...
that licence asks for. [THIRD-PARTY-NOTICES.md](THIRD-PARTY-NOTICES.md) says so
in full, with the licence text of every component; it is generated by
`tools/gen-notices.py`, compiled into the window so «About» can show it, and
